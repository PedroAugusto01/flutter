...
class SegundaTela2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Corpo corpo = Corpo('2');
    Botoes2 botao2 = Botoes2('terceira');
    return Tela('Segunda Tela', corpo, botao2);
  }
}
    ...
    return Row(
      ...
      children: [
        ElevatedButton(
          ...
          onPressed: () {
            Navigator.pushNamed(context, '/${this.primeira}');
          },
        ),
        ElevatedButton(
          child: Icon(Icons.navigate_next),
